...
# for dp, dn, fn in os.walk(os.path.expanduser("~dl687\Desktop\computer science\경북대\영상이해.\original_data")):
for dp, dn, fn in os.walk(os.path.expanduser(".\original_data")):
        # print(dp + " " + str(dn) + " " + str(fn) +"\n")
        for f in fn:
                input_files.append(os.path.join(dp,f))
